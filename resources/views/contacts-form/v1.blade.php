<div id="content" class="page-content site-content single-post" role="main">
    <div class="row">
        <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-4">
            ...
            <div id="info_list_1" class="info-list-w-icon">
                <div class="row no-gutters">
                    <div class="col-12 col-md-6 col-lg-12 info-block-w-icon">
                        <div class="ci-icon">
                            <i class="linecons linecons-mail"></i>
                        </div>
                        <div class="ci-text">
                            <h4 class="contacts-email-head"><a href="mailto:dovydasbukauskas@gmail.com">dovydasbukauskas@gmail.com</a>
                            </h4>
                ...
                <div class="row no-gutters">
                    <div class="col-12 col-md-6 col-lg-12 info-block-w-icon">
                        ...
                        <div class="ci-text">
                            <h4 class="margin-0"><a href="https://www.linkedin.com/in/dovydas-bukauskas/"
        ...
        <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-8">
            ...
            <form id="contact_form" class="contact-form" action="{{ route('contacts.post') }}" method="pOsT">
                @csrf
                        ...
                        <div class="right-column">
                            <div class="form-group form-group-with-icon">
                                <textarea id="form_message" name="message" class="form-control" placeholder="* Message"
                                          rows="7" required="required" data-error="Please, leave me a message."></textarea>
                                <div class="form-control-border"></div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
